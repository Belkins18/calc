...
;(function($) {
    var units = {
            ...
            ru: ['часов', 'минут', 'секунд'],
            ua: ['годин', 'хвилин', 'секунд'],
            kz: ['сағат', 'минут', 'секунд'],
            sec: [3600, 60, 1]
        },
        defaults = {
            etType: 1,
